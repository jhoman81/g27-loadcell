#include <HX711.h>    // bogde HX711 library  - see ZIP file
...
const float G27BrakeFull_v = 1.9;
const float G27BrakeOff_v = 3.1;
const float dac_BrakeFullPerc = G27BrakeFull_v / arduino_vcc;
const float dac_BrakeOffPerc = G27BrakeOff_v / arduino_vcc;
...

{
  ...
  if (dacValue * dac_step > G27BrakeOff_v) {
    dacValue = G27BrakeOff_v;
  }
